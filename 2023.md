...
|:-----|:--------:|:----------:|:-----------:|
| [dgraph](https://dgraph.io/) | <div style="width: 50pt">Dgraph is a horizontally scalable and distributed GraphQL database with a graph backend.</div> | [yes](https://github.com/dgraph-io/dgraph) |<div style="width: 150pt"><img src=https://flat.badgen.net/github/last-commit/dgraph-io/dgraph ></div>|
| [Neo4j](https://neo4j.com/) | <div style="width: 50pt">With proven trillion+ entity performance, developers</div> | [yes](https://github.com/neo4j) |<div style="width: 200pt"> ![dgraph](https://flat.badgen.net/github/last-commit/dgraph-io/dgraph)</div> |
___
## Contributors
